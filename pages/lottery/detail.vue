  ...
  <view class="container">
    <unicloud-db ref="udb" v-slot:default="{data, loading, error, options}" :options="options" :collection="collectionList" field="title,photo" :where="queryWhere" :getone="true" :manual="true">
      ...
      <view v-else-if="data">
        ...
        <view>
          <text>图片</text>
          <uni-file-picker v-if="data.photo && data.photo.fileType == 'image'" v-model="data.photo" :file-mediatype="data.photo && data.photo.fileType" return-type="object" readonly></uni-file-picker>
