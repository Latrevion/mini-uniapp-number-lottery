...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            e: "7fc74853-2-" + i0 + "-" + i1 + "," + ("7fc74853-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "7fc74853-1-" + i0 + ",7fc74853-0"
      } : {}, {
        c: data,
        g: "7fc74853-3-" + i0 + ",7fc74853-0",
        h: common_vendor.p({
    ...
    b: common_vendor.sr("udb", "7fc74853-0"),
    c: common_vendor.p({
      collection: $data.collectionList,
      field: "title,photo"
    }),
    d: common_vendor.sr("fab", "7fc74853-4"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/class-learn/2023/choujiang/pages/lottery/list.vue"]]);
